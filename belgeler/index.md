...
-   :material-rocket-launch:{ .lg .middle } **5 Dakikada Başlayın**
    ...
    [:octicons-arrow-right-24: Kurulum](tr/baslangic/kurulum.md)
...
-   :material-book-open-variant:{ .lg .middle } **16 Kural ile Denetim**
    ...
    [:octicons-arrow-right-24: Kurallar](tr/kurallar/index.md)
...
-   :material-github:{ .lg .middle } **Katkıda Bulunun**
    ...
    [:octicons-arrow-right-24: Katkı rehberi](tr/katki/fork-is-akisi.md)
...
-   :material-translate:{ .lg .middle } **English Docs**
    ...
    [:octicons-arrow-right-24: English](en/index.md)
